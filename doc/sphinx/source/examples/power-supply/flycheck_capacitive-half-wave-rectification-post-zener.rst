...
========================================================
 Flycheck_Capacitive Half Wave Rectification Post Zener
========================================================


.. getthecode:: flycheck_capacitive-half-wave-rectification-post-zener.py
    :language: python

This example shows a capacitive power supply with a post zener half-rectification. A capacitive
power supply is a kind of transformless power supply.
...
.. image:: capacitive-half-wave-rectification-post-zener-circuit.png
  :align: center
