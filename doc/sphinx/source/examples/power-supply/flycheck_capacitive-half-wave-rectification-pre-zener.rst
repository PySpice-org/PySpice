...
=======================================================
 Flycheck_Capacitive Half Wave Rectification Pre Zener
=======================================================


.. getthecode:: flycheck_capacitive-half-wave-rectification-pre-zener.py
    :language: python
...
.. code-block:: python
    ...
    plt.legend(('Vin [V]', 'Vout [V]', 'V2 [V]', 'V3 [V]', 'VC [V]'), loc=(.8,.8))
    plt.grid()
    plt.xlabel('t [s]')
    plt.ylabel('[V]')
